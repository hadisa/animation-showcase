...
export const HoverAnimationCard = (props: any) => {
  // Customize the hover animation card
  return (
    <BaseAnimationCard {...props}>
      {/* Custom content for hover animations */}
      {/* <div className="bg-gradient-to-br from-green-100 to-emerald-100 rounded-xl p-8 flex items-center justify-center min-h-[140px] relative overflow-hidden group/hover-preview">
                <div className="absolute inset-0 bg-gradient-to-br from-green-500/5 to-emerald-500/5 opacity-50"></div>
                <div
                    className={`w-20 h-20 bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl flex items-center justify-center relative z-10 transition-all duration-300 group-hover/hover-preview:scale-110 group-hover/hover-preview:rotate-6 ${props.playingAnimations.has(props.animation.id) ? props.animation.preview : ""
                        }`}
                >
      ...
      {/* <AnimatedBrightBorderCard {...props.animation} /> */}
