            ...
            <Card className="h-full">
              ...
              <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as 'preview' | 'code')}>
                <TabsList className="w-full justify-start px-4 pt-2 pb-0 bg-transparent border-b rounded-none">
                  ...
                  <TabsTrigger value="code" className="data-[state=active]:shadow-none">Source Code</TabsTrigger>
                </TabsList>
                <div className="p-4">
                  ...
                  <TabsContent value="code" className="m-0">
                    {selectedAnim ? (
                      <div className="relative">
                        ...
                        <div className="max-h-[500px] overflow-auto bg-gray-900 rounded-lg p-4">
                          <CodeBlock
                            title={selectedAnim.title}
                            language="tsx"
