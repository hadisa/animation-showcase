...
export default function AnimatedCard({
  ...
  return (
    <div
      className="relative w-[340px] h-[480px] font-sans"
      style={{ perspective: 1000 }}
    >
      <div className="card-wrapper relative w-[340px] h-[480px] ">
        <Card
          className={cn(
            "card-content w-full h-full  bg-slate-900 border-slate-700 transition-all duration-300",
            className
          )}
        >
          <CardHeader>
      ...
      <style jsx global>{`
        ...
        .card-wrapper:hover .card-content {
          ...
          box-shadow: 0 0 15px rgba(192, 132, 252, 0.5),
            /* Purple glow */ 0 0 30px rgba(56, 189, 248, 0.3); /* Blue glow */
