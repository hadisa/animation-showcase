...
const LoadingPro = ({ initialProgress = 0 }) => {
  ...
  useEffect(() => {
    ...
    }, 10000); // Adjust interval for speed
  ...
  return (
    ...
    <div className="relative flex justify-center items-center w-[340px] h-[480px]  mx-auto p-8 rounded-lg bg-black shadow-2xl overflow-hidden font-sans ">
