...
export default function QuantumShapesAnimationRefined() {
  return (
    <>
      <Head>
        <title>Quantum Innovations | Shapes Animation</title>
      </Head>
      ...
      <div className="flex items-center justify-center w-[340px] h-[480px]relative overflow-hidden bg-gradient-to-br from-[#061833] to-[#011421]">
        ...
        <div className="shapes-container relative w-full h-full">
          {/* Top-left shape (now a sharp square) */}
          <div className="shape shape-top-left absolute w-96 h-96 top-0 left-0 animate-shape-float"></div>
          <div className="shape shape-top-left absolute w-120 h-120 top-0 left-5 animate-shape-float"></div>
          {/* Bottom-right shape (now a sharp square) */}
      ...
      <style jsx>{`
        ...
        .shape-top-left {
          ...
          border-radius: 0; /* Changed to make it a sharp square */
        }
